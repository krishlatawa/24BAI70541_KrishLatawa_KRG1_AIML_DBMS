...
![Output](Exp-8_Images/Output-1.png)
...
(101, 'Krish', 'Male', 30000),
(102, 'Sarah', 'Female', 55000),
(103, 'Riyanshi', 'Female', 45000),
(104, 'Mohan', 'Male', 59000),
(105, 'Shrija', 'Female', 66000);
```

**Output:**


![Output](Exp-8_Images/Output-2.png)
...
![Output](Exp-8_Images/Output-3.png)
...
![Output](Exp-8_Images/Output-4.png)
