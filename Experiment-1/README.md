📖 Library Management System Database 🧪 Experiment 1.1 🎯 Aim
...
A database role named LIBRARIAN is created with login access. Required privileges are granted and revoked on tables to demonstrate role-based database security.
